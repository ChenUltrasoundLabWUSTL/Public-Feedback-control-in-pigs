function varargout = UTSW_v2_Chien_FB(varargin)
% UTSW_V2_CHIEN_FB MATLAB code for UTSW_v2_Chien_FB.fig
%      UTSW_V2_CHIEN_FB, by itself, creates a new UTSW_V2_CHIEN_FB or raises the existing
%      singleton*.
%
%      H = UTSW_V2_CHIEN_FB returns the handle to a new UTSW_V2_CHIEN_FB or the handle to
%      the existing singleton*.
%
%      UTSW_V2_CHIEN_FB('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in UTSW_V2_CHIEN_FB.M with the given input arguments.
%
%      UTSW_V2_CHIEN_FB('Property','Value',...) creates a new UTSW_V2_CHIEN_FB or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before UTSW_v2_Chien_FB_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to UTSW_v2_Chien_FB_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help UTSW_v2_Chien_FB

% Last Modified by GUIDE v2.5 23-Jun-2021 15:29:05

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @UTSW_v2_Chien_FB_OpeningFcn, ...
    'gui_OutputFcn',  @UTSW_v2_Chien_FB_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before UTSW_v2_Chien_FB is made visible.
function UTSW_v2_Chien_FB_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to UTSW_v2_Chien_FB (see VARARGIN)

% Choose default command line output for UTSW_v2_Chien_FB
...
function varargout = UTSW_v2_Chien_FB_OutputFcn(hObject, eventdata, handles)
...
SonicationDuration = 20;%200;        % s, total time for sonication
...
Vstep = 1;
SC_range = 56373:56876;%(94121:94624); %fifth harmonic
IC_range = (9187:9690); %sub-harmonic
